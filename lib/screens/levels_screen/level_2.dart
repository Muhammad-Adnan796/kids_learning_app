...
class _Level2State extends State<Level2> {
  ...
  final List levels2Data = List.generate(
      level2NameList.length,
          (index) => LevelDataModal(
        name: level2NameList[index],
        image: level2PicList[index],
      ));
